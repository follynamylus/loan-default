...
st.title("Loan Default Prediction Application Using Random Forest")
...
dt = {"person_age":[False],"person_income":[False],"person_emp_length":[False],"loan_amnt":[False],"loan_int_rate":[False],
        ...
        "cb_person_cred_hist_length":[False],"person_home_ownership_MORTGAGE":[False],"person_home_ownership_OTHER":[False],
